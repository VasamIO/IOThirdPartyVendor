...
(function withAngular(angular) {
  ...
  .directive('iosocialshare', ['$window', '$location', function manageDirective ($window, $location) {
      ...
      'link': function linkingFunction ($scope, element, attr) {
        ...
        for (key in propDefaults) {
          if (propDefaults.hasOwnProperty(key)) {
            attributeName = 'iosocialshare' + key.substring(0, 1).toUpperCase() + key.substring(1);
